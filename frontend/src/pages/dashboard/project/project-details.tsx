...
import { AlertCircle, Calendar, CheckCircle, Clock, Loader } from 'lucide-react';
              ...
              <div className='flex -space-x-2'>
                {
                  task.assignees.slice(0, 5).map((member) => (
                    <Avatar
                      key={member._id}
                      className='relative size-8 rounded-full bg-gray-700 border-2 border-background overflow-hidden'
